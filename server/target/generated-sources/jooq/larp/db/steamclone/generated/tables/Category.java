...
public class Category extends TableImpl<CategoryRecord> {
    ...
    /**
     * The reference instance of <code>steamclone.Category</code>
     */
    ...
    /**
     * The column <code>steamclone.Category.type</code>.
     */
    public final TableField<CategoryRecord, String> TYPE = createField(DSL.name("type"), SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>steamclone.Category.description</code>.
     */
    public final TableField<CategoryRecord, String> DESCRIPTION = createField(DSL.name("description"), SQLDataType.VARCHAR(255).nullable(false), this, "");
    ...
    /**
     * Create an aliased <code>steamclone.Category</code> table reference
     */
    ...
    /**
     * Create a <code>steamclone.Category</code> table reference
     */
    public Category() {
